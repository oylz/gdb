			  ...
			  const struct language_defn *language)
{
  ...
  fprintf(stderr, " \033[31m| \033[32m| \033[33m| \033[34m| \033[35m|XYZ, in apply_val_pretty_printer A\n");
  if (! printer || printer == Py_None)
    goto done;
  fprintf(stderr, " \033[31m| \033[32m| \033[33m| \033[34m| \033[35m|XYZ, in apply_val_pretty_printer B\n");
  /* If we are printing a map, we want some special formatting.  */
  hint = gdbpy_get_display_hint (printer);
  fprintf(stderr, " \033[31m| \033[32m| \033[33m| \033[34m| \033[35m|XYZ, in apply_val_pretty_printer, hint:[%s]\n", hint);
